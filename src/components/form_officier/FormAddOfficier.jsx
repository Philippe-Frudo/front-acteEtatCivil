            ...
            <div className="modal add-modal">
                <div className="modal-container">
                    <div className="modal-header">
                        ...
                        <div>
                            <button type="reset" className="btn btn-close" id="close-modale-add" onClick={hiddenAddModal}>X</button>
                        </div>
                    </div>
                    <form className="form" id="add-officier">
                        ...
                        <div className="content-user">
                            ...
                            <div className="form-group">
                                <div>
                                    <label htmlFor="email_O" className="form-group-label">Mot de passe:</label>
                                    <input type="email" className="form-group-input email_O" name="email_O" id="email_O" placeholder="exemple@gmail.com" />
                                    <span className="msg-error"></span>
                                </div>
                            </div>
                            <div className="form-group">
...
export default FormAddOfficier
